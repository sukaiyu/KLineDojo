        ...
        {isPlaying && !isGameOver() && (
          <>
            <button
              ...
              className="btn-secondary py-1.5 px-1 sm:py-2 sm:px-2 text-xs sm:text-sm whitespace-nowrap flex-1"
              title="空格键: 暂停/继续游戏"
            >
              {isPaused ? '继续' : '暂停'}
            </button>
            ...
            {isPaused && (
              <button
                onClick={nextKLine}
                className="btn-primary py-1.5 px-1 sm:py-2 sm:px-2 text-xs sm:text-sm whitespace-nowrap flex-1"
                title="→键: 推进一根K线"
              >
                下一日
              </button>
